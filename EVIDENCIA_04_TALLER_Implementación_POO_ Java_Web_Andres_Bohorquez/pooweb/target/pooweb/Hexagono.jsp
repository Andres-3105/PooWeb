...
<body>
    ...
    <div class="figure">
      <img src="Imagenes/Hexagono.png" alt="Hexágono">
      <p>Hexágono</p>
    </div>
    ...
    <form action="figura" method="post">
      ...
      <button type="submit" name="control" value="areahexa">Calcular</button>
    </form>
    ...
    <form action="figura" method="post">
      ...
      <button type="submit" name="control" value="perimetrohexa">Calcular</button>
    </form>
    <p style="justify-content: center; color: aliceblue; font-size: 1.25em;">
